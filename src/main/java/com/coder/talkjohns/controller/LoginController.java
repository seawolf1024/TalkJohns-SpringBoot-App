...
public class LoginController implements CommunityConstant {
    ...
    public String getRegisterPage(){
        return "/site/register"; //means template/site/register(.html)
    }

    @RequestMapping(path = "/login", method = RequestMethod.GET)
    public String getLoginPage(){
        return "/site/login"; //means template/site/login(.html)
    }
    @RequestMapping(path = "/register", method = RequestMethod.POST)
    public String register(Model model, User user){
        Map<String, Object> map = userService.register(user);
        if(map == null || map.isEmpty()){
            model.addAttribute("msg", "An activation email has been send to your account.");
            model.addAttribute("target", "/index");
            return "/site/operate-result"; //template/site/operate-result
        }else{
    ...
    public String activation(Model model, @PathVariable("userId") int userId, @PathVariable("code") String code){
        ...
        if(result == ACTIVATION_SUCCESS){
            ...
            model.addAttribute("msg", "Invaild: Your account has already been " +
                    "activated.");
            model.addAttribute("target", "/index");
        }else{
            // FAILURE
            model.addAttribute("msg", "Incorrect activation code. Please check again.");
            model.addAttribute("target", "/index");
        }
    ...
    public void getKaptcha(HttpServletResponse response/*, HttpSession session*/){
        ...
        // Store verification code to redis
        ...
        try {
            ...
            logger.error("Failed to get verification code:" + e.getMessage());
        }
    }
